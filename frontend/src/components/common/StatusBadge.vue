...
const variantClasses = computed(() => {
  switch (props.variant) {
    ...
    case 'online':
    case 'active':
      return 'bg-emerald-500/15 text-emerald-700 dark:text-tertiary-fixed-dim border border-emerald-500/30 dark:border-tertiary-fixed-dim/30'
    case 'danger':
    case 'offline':
    case 'inactive':
      return 'bg-red-500/15 text-red-700 dark:text-error border border-red-500/30 dark:border-error/30'
    case 'warning':
    ...
    case 'primary':
      return 'bg-cyan-500/15 text-cyan-800 dark:text-primary-fixed-dim border border-cyan-500/30 dark:border-primary-fixed-dim/30'
    case 'superuser':
...
const dotColorClasses = computed(() => {
  switch (props.variant) {
    ...
    case 'online':
    case 'active':
      return 'bg-emerald-600 dark:bg-tertiary-fixed-dim'
    case 'danger':
    case 'offline':
    case 'inactive':
      return 'bg-red-600 dark:bg-error'
    case 'warning':
      return 'bg-amber-600 dark:bg-amber-400'
    case 'info':
      return 'bg-sky-600 dark:bg-sky-400'
    case 'primary':
      return 'bg-cyan-700 dark:bg-primary-fixed-dim'
    case 'superuser':
