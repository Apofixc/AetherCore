...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'glow-primary-sm': '0 0 10px rgba(var(--primary-rgb), 0.15)',
        'glow-primary-md': '0 0 15px rgba(var(--primary-rgb), 0.25)',
        'glow-primary-lg': '0 0 20px rgba(var(--primary-rgb), 0.35)',
        'glow-tertiary-sm': '0 0 8px rgba(var(--tertiary-rgb), 0.5)',
        'glow-inset': 'inset 0 0 10px rgba(var(--primary-rgb), 0.1)',
        'glow-inset-hover': 'inset 0 0 15px rgba(var(--primary-rgb), 0.2)',
