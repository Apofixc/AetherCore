...
//!
//! Гарантирует отсутствие конфликтов `database is locked` при высокочастотной
//! круглосуточной записи телеметрии и событий.
...
impl Db {
    ...
    /// Заполнить стандартные роли и права системы
