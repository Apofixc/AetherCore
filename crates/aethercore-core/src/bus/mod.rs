...
impl EventBus {
    ...
    /// * `limit` — Максимальное количество возвращаемых сообщений (ограничивается сверху константой `MAX_INITIAL_RETAINED_LIMIT` = 100).
    ...
    /// * `max_initial_retained` — Максимальное количество сохраненных сообщений для начального состояния (ограничивается сверху константой `MAX_INITIAL_RETAINED_LIMIT` = 100).
    ///
    ...
    /// Получить ссылку на сборщик метрик шины
